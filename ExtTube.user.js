...
// @version      1.2.5
// @description  Adds Invidious buttons to YouTube videos and replaces the YouTube player with Invidious player.
// @author       ExtTube
...
(function() {
    ...
    function addInvidiousButtons() {
        ...
        playerButton.style.padding = '4px 12px'; // Smaller button size
